    ...
    <header>
        <div class="headerContainer">
            <div class="mainIncludeAndImge">
                <div class="form">
                    <h2>Sign In</h2>
                    <form action="<?php if(isset($_GET['flightid'])){ echo "phpScripts/singinafterRes.php?flightid= ". $_GET['flightid'] ."&price=" . $_GET['price']; }else{ echo  "phpScripts/sign_script.php";} ?>" method="POST">
                        <input type="text" name="email" placeholder="Email">
                        <input type="password" name="password" placeholder="Password">
                        <input type="submit" name="submitSignin" class="submit" value="Sign in">
                        <p class="error">
                            <?php
                            if (isset($_GET['error'])) {
                                if ($_GET['error'] == 'empty') {
                        ...
                        <br>
                        <p>If you are new here, create your first account from here <a href="SingUp.php">Sign Up</a></p>
                    </form>
