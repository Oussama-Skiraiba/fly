...
//     header("Locatio: http://localhost/progectOfppt-main/app/HommePage.php");
// }

session_start();
// $_SESSION['isLogin'] = true;
// if (!isset($_SESSION['isLogin']) && $_SESSION['isLogin'] !== true) {
// header('Location: http://localhost/ProgectOfppt/app/SingIn.php');
// }
                ...
                <div class="passportInfo" id="block">
                    ...
                    <!-- <div class="paddingInfp">
                        <div class="info__1">
                            ...
                            <input type="text" placeholder="Passport Number" id="NumberPAssport">
                            ...
                            <select name="" id="NationalityPassport">
                    ...
                    <form action="http://localhost/progectOfppt-main/app/phpScripts/addPPWhileRe.php?flightid=<?php echo $_GET['flightid']; ?>&price<?php echo $_GET['price']; ?>=&userid=<?php echo $_GET['userid']; ?>" method="post" class="addPassPortForm">
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" name="passNati"/>
                        </div>
                        <div>
                            <lable>Date of issue</lable>
                            <input type="date" name="passSat"/>
                        </div>
                        <div>
                            <lable>Date of expiry</lable>
                            <input type="date" name="passEnd"/>
                        </div>
                        <input type="submit" name="addpp" class="addpp" value="Add Passport">
                    </form>
...
<script src="../../js/step/step2.js"></script>
